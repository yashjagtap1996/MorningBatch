                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div className="d-flex" role="search">
                            <button className={`bg-${mode?"dark":"light"} border-0`} onClick={()=>setMode(!mode)}>{mode?<BsFillSunriseFill className='text-warning' />:<BsFillMoonStarsFill className='text-warning' />}</button>
                        </div>
                    </div>
                </div>
            </nav>
